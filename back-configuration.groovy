...
datas.spec.template.spec.containers[0]["envFrom"]["configMapRef"][0]=["name":"${appName}"+'-test']        
datas.spec.template.spec.containers[0]["envFrom"]["secretRef"][0]=["name":"${appName}"+'-test']        
